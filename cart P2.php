...
<div class="Fragrance">
  ...
  <img id="myimage" src="pic 28.jpg" width="300" height="340">
  <div id="myresult" class="img-zoom-result"></div>
</div>
<h2>M Panjabi in White Colourful Print</h2>
...
<div class="card">
 <p><a href="cart P2.php"><button>Add to Cart</button></a></p>
</div>
