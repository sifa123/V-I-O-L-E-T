...
<head>
 ...
 <meta http-equiv="X-UA-Compatible" content="IE=edge">
  ...
  <link rel="stylesheet" type="text/css" href="Women's Tops.css">
     <link rel="stylesheet" type="text/css" href="Final Cart.php">
...
<div class="Fragrance">
  ...
  <img id="myimage" src="pic 11.jpg" width="300" height="340">
  <div id="myresult" class="img-zoom-result"></div>
</div>
<h2>W off white printed</h2>
<br>Product Type &nbsp; &nbsp; &nbsp; Women Wear</br>
<h2>W off white printed</h2>
<br><h3>Size</h3></br>
...
<div class="card">
 <p><a href=" Final Cart.php"><button>Add to Cart</button></a></p>
</div>
